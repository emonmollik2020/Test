...
def load_state():
    if not os.path.exists(STATE_FILE):
        return {
            ...
            "analysis_1m": {"rsi": 0, "ema20": 0, "ema50": 0, "bu": 0, "bl": 0, "sig": "অপেক্ষা", "pats": []},
...
# --- প্যাটার্ন ডিটেক্টর (ফরম্যাট ফিক্স করা হয়েছে) ---
def detect_pats(df):
    p = []
...
<head>
    ...
    <style>
        ...
        .tag-bull { background: #dcfce7; color: #166534; font-size: 10px; font-weight: 700; padding: 2px 8px; border-radius: 99px; }
        .tag-bear { background: #fee2e2; color: #991b1b; font-size: 10px; font-weight: 700; padding: 2px 8px; border-radius: 99px; }
        .tag-neut { background: #f1f5f9; color: #475569; font-size: 10px; font-weight: 700; padding: 2px 8px; border-radius: 99px; }
    </style>
</head>
<body class="p-3">
<div class="max-w-md mx-auto text-slate-800">
    ...
    <div class="card p-4 mb-6"><h3 class="font-bold text-slate-700 text-xs mb-3">&#128203; লাইভ লগ</h3><div id="lg" class="space-y-1 text-[10px]"></div></div>
</div>
